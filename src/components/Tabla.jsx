...
const columns = [
  ...
  { id: 'age', label: 'Nombre', minWidth: 100 },
  { id: 'email', label: 'Especie', minWidth: 100 },
  { id: 'address', label: 'Raza', minWidth: 100 },
  { id: 'phone', label: 'Sexo', minWidth: 50 },
  { id: 'company', label: 'Color', minWidth: 80 },
  { id: 'position', label: 'F. Nacimiento', minWidth: 100 },
  { id: 'actions', label: 'Acciones', minWidth: 190 },
];
