...
const ListarCitas = ({ citas,onCitaActualizada,onCitaEliminada }) => {
  const [page, setPage] = useState(0);
  const [rowsPerPage, setRowsPerPage] = useState(4);
  const [citaSeleccionada, setCitaSeleccionada] = useState(null);
  const [citaSeleccionadaEliminar, setCitaSeleccionadaEliminar] = useState(null);
                  ...
                  <TableRow key={cita.nroCita}>
                    ...
                    <TableCell align="center">
                      ...
                      <Box
                        ...
                        margin="0 3px"
                      >
                        <IconButton onClick={() => handleOpenEliminarCita(cita)}>
