...
const ViewRecepcionCliente = () => {
  ...
  const handleEmpleadoActualizado = (empleadoId, datosActualizados) => {
    ...
    const empleadoIndex = empleados.findIndex((empleado) => empleado.empleadoId === empleadoId);

    if (empleadoIndex !== -1) {
  
      const nuevosEmpleados = [...empleados];
      nuevosEmpleados[empleadoIndex] = { ...nuevosEmpleados[empleadoIndex], ...datosActualizados };
    ...
    <>
      ...
      <Box bgcolor="#F0F0F0" p={2} display="flex" alignItems="center">
        <Grid container spacing={3} justifyContent="center">
          ...
          <Grid item xs={12}>
          <Tabla empleados={sortedEmpleados}/>
          </Grid>
        </Grid>
      </Box>
    </>
