...
import ModalAsignacionRol from "./ModalAsignacionRol";
...
const ListarUsuarios = ({
  ...
  const [usuarioSeleccionadoAsignacion, setUsuarioSeleccionadoAsignacion] =useState(null);
  const [asignarRol, setAsignarRol] = useState(null);
  ...
  const handleOpenAsignarRol = (usuario) => {
    setAsignarRol(usuario);
  };

  const handleCloseAsignarRol = () => {
    setAsignarRol(null);
  };

  const handleOpenAsignarModal = (usuario) => {
    setUsuarioSeleccionadoAsignacion(usuario);
  };

  const handleCloseAsignarModal = () => {
    setUsuarioSeleccionadoAsignacion(null);
  };
  ...
  return (
    <>
                ...
                .map((usuario) => (
                  <TableRow key={usuario.usuarioId}>
                    ...
                    <TableCell align="center">
                      ...
                      >
                        <IconButton
                          onClick={() => handleOpenAsignarModal(usuario)}
                        >
                      ...
                      >
                        <IconButton
                          onClick={() => handleOpenAsignarRol(usuario)}
                        >
                      ...
                      >
                        <IconButton
                          onClick={() => handleOpenEliminarUsuario(usuario)}
                        >
      ...
      {asignarRol && (
        <AsignarRol
          usuarioId={asignarRol.usuarioId}
          userName={asignarRol.userName}
          onCloseAsignarRol={handleCloseAsignarRol}
        />
      )}

  {usuarioSeleccionadoAsignacion && (
        <ModalAsignacionRol
          usuarioId={usuarioSeleccionadoAsignacion.usuarioId}
          userName={usuarioSeleccionadoAsignacion.userName}
          onCloseAsignarModal={handleCloseAsignarModal}
        />
      )}
